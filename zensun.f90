program sunpos
implicit none
	real lat,long, time,lon,sun_zenith,sun_azimuth, tz
	integer day
...
50	write(*,*) 'time:   (99 = exit)'
	...
	If (time == 99) goto 99
	time = time - tz
	call zensun(day,time,lat,lon,sun_zenith,sun_azimuth)
	write (*,*) sun_zenith, sun_azimuth
	goto 50
...
real, parameter :: pi = 3.14159265358
  integer   di,day
  real     time,lat,lon,z,gaz
  real      ut,noon
  real      y(5),y2(5),x(2,5),Tx(5,2),xTx(2,2),aTx(5,2),det
  real      tt,eqtime,decang,latsun,lonsun
  real      nday(74),eqt(74),dec(74)
  real      beta(2), beta2(2), a(2,2)
  real      t0,t1,p0,p1,zz,xx,yy
